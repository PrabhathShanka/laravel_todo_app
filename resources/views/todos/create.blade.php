        ...
        <div class="modal-body">
            <form method="post" action="{{ route('todos.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="description" name="description" placeholder="add a description" required></textarea>
                </div>
                <div class="mb-3">
                    <label for="category" class="form-label">Select Tags</label>
